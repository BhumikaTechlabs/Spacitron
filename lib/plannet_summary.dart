...
import 'package:spacitron/separator.dart';
import 'package:spacitron/DetailPage.dart';
import 'package:spacitron/text_style.dart';
...
class PlanetSummary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final planetCardContent = new Container(
      margin: new EdgeInsets.fromLTRB(horizontal ? 76.0 : 16.0, horizontal ? 16.0 : 42.0, 16.0, 10.0),
